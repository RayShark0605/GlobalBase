...
public:
    ...
    // 欧氏距离。结果超过 double 可表示范围时返回正无穷，而不是 NaN。
...
GLOBALBASE_PORT GB_Point2d operator*(double scalar, const GB_Point2d& point);
